...
let
  automount_opts = [
    "x-systemd.automount,noauto,x-systemd.idle-timeout=60,x-systemd.device-timeout=5s,x-systemd.mount-timeout=5s,uid=phil,gid=users,credentials=/run/user/1000/agenix/smb-secrets"
  ];
in
{
  config = {
